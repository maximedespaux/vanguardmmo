...
export const PRESTIGE_COSTS: Record<number, Record<string, number>> = {
  ...
  7: { "Périn": 500, "Nucléus neutre": 25000, "Nucléus parfait": 25000, "Badge World Boss prestigieux": 1 },
  8: { "Badge Jardin Prestigieux": 10, "Badge de la Tour": 1, "Badge de donjon mineur": 2, "Badge World Boss prestigieux": 1 },
  9: { "Emblème de protection": 4000, "Nucléus parfait": 49995, "Badge Donjon": 2, "Badge de donjon mineur": 2, "Badge Jardin Prestigieux": 25, "Badge World Boss prestigieux": 2 },
};
