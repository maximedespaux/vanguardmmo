...
function delM(m){agConfirm('Supprimer le coffre de '+m+' ? Le contenu sera perdu.',function(){S.members=S.members.filter(x=>x!==m);delete S.inv[m];if(S.cur===m)S.cur='__total__';save();render();});}
